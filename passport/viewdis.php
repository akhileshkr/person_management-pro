...
<?php
$sel="select * from tbl_state s,tbl_district d,tbl_place p,tbl_survey su,tbl_adddis m where s.state_id=d.state_id and d.dist_id=p.dist_id and p.dist_id=su.dist_id and p.place_id=su.place_id and su.adhar=m.adhar";
