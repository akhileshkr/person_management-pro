...
<tr><td><input type="text" name="txtdis" placeholder="enter diseases" class="textbox" required></td></tr>
<tr><td align="center"><input type="submit" name="add" value="Add" class="button"></td></tr>
...
if(isset($_POST['add']))
{
	...
	{
	$q=mysqli_query($con,"insert into tbl_adddis values('0','$adhar','$date','$email','$report','0');");
